...
type PhCircleWavyQuestionBoldProps = SVGProps<SVGSVGElement> & {
  color: string;
};

export function PhCircleWavyQuestionBold(props: PhCircleWavyQuestionBoldProps) {
  return (
    <svg
