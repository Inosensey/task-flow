...
type SvgSpinnersBlocksShuffle3Props = SVGProps<SVGSVGElement> & {
  color: string
}
...
export function SvgSpinnersBlocksShuffle3(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <rect width="10" height="10" x="1" y="1" fill={props.color} rx="1">
        <animate
      ...
      <rect width="10" height="10" x="1" y="13" fill={props.color} rx="1">
        <animate
      ...
      <rect width="10" height="10" x="13" y="13" fill={props.color} rx="1">
        <animate
...
export default SvgSpinnersBlocksShuffle3;
